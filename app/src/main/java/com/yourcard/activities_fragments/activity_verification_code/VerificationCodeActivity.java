package com.yourcard.activities_fragments.activity_verification_code;
...
import com.yourcard.databinding.ActivityVerificationCodeBinding;
    ...
    private void startTimer() {
        ...
        timer = new CountDownTimer(60 * 1000, 1000) {
            ...
            public void onFinish() {
                binding.tvResendCode.setText(getResources().getString(R.string.resend));
